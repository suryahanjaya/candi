...
const messages = {
  id: {
    ...
    emptyDescription: 'Belum ada catatan yang dibuat. Mulai menulis catatan pertama Anda sekarang!',
  ...
  en: {
    ...
    empty: 'No notes',
    emptyDescription: 'No notes created yet. Start writing your first note now!',
